            ...
            public void onSignalQuality(int level) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.d(TAG, "signal quality = " + sqStr);
...
//                    tgStreamReader.startRecordRawData();
                    ...
                    EEGActivity.this.runOnUiThread(new Runnable() {
                        public void run() {
